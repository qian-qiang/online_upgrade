...
#if defined (SOC_SERIES_180M)     /* APB1 45MHz(max) */
static const struct stm32_baud_rate_tab can_baud_rate_tab[] =
{
...
#endif
#if defined (SOC_SERIES_168M)     /* APB1 42MHz(max) */
static const struct stm32_baud_rate_tab can_baud_rate_tab[] =
{
...
#endif
#elif defined (SOC_SERIES_STM32F7)/* APB1 216MHz(max) */
#if defined (SOC_SERIES_216M)
static const struct stm32_baud_rate_tab can_baud_rate_tab[] =
{
